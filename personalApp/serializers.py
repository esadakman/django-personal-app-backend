...
class DepartmentSerializer(serializers.ModelSerializer):
    ...
    def get_personal_count(self,obj):
        return Personal.objects.filter(department = obj.id).count()# deparmentlardaki personelleri saydırdık

class PersonalSerializer(serializers.ModelSerializer):
    days_since_joined = serializers.SerializerMethodField()# https://www.django-rest-framework.org/api-guide/fields/#serializermethodfield

    create_user= serializers.StringRelatedField()#https://www.django-rest-framework.org/api-guide/relations/#stringrelatedfield
